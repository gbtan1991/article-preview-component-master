  ...
  return (
    <section className="grid place-content-center h-screen shadow-lg">
      <div className="flex flex-col w-[330px] sm:flex-row sm:w-[730px] sm:h-[320px]">
        ...
        <div
          className={`bg-white py-5 justify-between rounded-br-xl rounded-bl-xl sm:px-10 sm:py-6 sm:rounded-bl-none sm:rounded-tr-xl `}
        >
          ...
          <p
            className={`text-sm text-desaturatedDarkBlue px-8 pb-4`}
          >
          ...
          <div className={`relative`}>
              ...
              <div className="flex flex-row justify-between px-8">
                ...
                <button
                  className="bg-lightGrayishBlue w-8 h-8 rounded-full flex items-center justify-center sm:visible"
                  onClick={toggleShare}
                >
                  <FaShare color="" />
                </button>
              </div>
              {showShare && <Share toggleShare={toggleShare} showShare={showShare} /> }
