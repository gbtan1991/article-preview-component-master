  ...
  return (
    <section className="grid place-content-center h-screen shadow-lg">
      <div className="flex flex-col  w-[330px] sm:flex-row sm:w-[730px] sm:h-[280px]">
        ...
        <div className="bg-white px-0 py-5 justify-between rounded-br-xl rounded-bl-xl sm:px-10 sm:py-6 sm:rounded-bl-none sm:rounded-tr-xl ">
          <h2 className="py-3 px-8 font-Manrope text-veryDarkGrayisBlue font-extrabold sm:text-xl">
            Shift the overall look and feel by adding these wonderful touches to
            furniture in your home
          </h2>
          <p className="text-sm text-desaturatedDarkBlue px-8 ">
            Ever been in a room and felt like something was missing? Perhaps it
            felt slightly bare and uninviting. I've got some simple tips to help
            you make any room feel complete.
          </p>
          <div>
           {showShare ? <Share toggleShare={toggleShare}/> : (<div className="flex flex-row   px-8">
